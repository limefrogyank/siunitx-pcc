const angCases = [
  ...
  String.raw`\ang[fill-angle-degrees]{;-2;}`,
  String.raw`\sisetup{fill-angle-degrees}\ang{;-2;}`,
...
type SiunitxNodeTestSection = {
  title: string;
  cases: string[];
};

export const testSections: SiunitxNodeTestSection[] = [
  { title: 'ang', cases: angCases },
  { title: 'num', cases: numCases },
  { title: 'complexnum & complexqty', cases: complexnumCases },
  { title: 'unit', cases: unitCases },
  { title: 'qty', cases: qtyCases },
  { title: 'numlist, qtylist, numproduct, qtyproduct, numrange, qtyrange', cases: listStuffCases },
